        ...
        <Formik validationSchema={registerScehma} initialValues={{firstName: '', lastName: '', company: '', email: '', password: ''}} onSubmit={(values, { setSubmitting }) => {
            ...
            {({
                ...
                <Form.Group controlId="formBasicFirstname">
                    <Form.Control type="text" placeholder="First name" name="firstName" value={values.firstName} onChange={handleChange} onBlur={handleBlur} className="email-login-input"/>
                    <Form.Text className="text-danger">{touched.firstName && errors.firstName ? errors.firstName : null}</Form.Text>
                </Form.Group>
                <Form.Group controlId="formBasicLastname">
                    <Form.Control type="text" placeholder="Last name" name="lastName" value={values.lastName} onChange={handleChange} onBlur={handleBlur} className="email-login-input"/>
                    <Form.Text className="text-danger">{touched.lastName && errors.lastName ? errors.lastName : null}</Form.Text>
                </Form.Group>
                <Form.Group controlId="formBasicCompany">
                    <Form.Control type="text" placeholder="Company" name="company" value={values.company} onChange={handleChange} onBlur={handleBlur} className="email-login-input"/>
                    <Form.Text className="text-danger">{touched.company && errors.company ? errors.company : null}</Form.Text>
                </Form.Group>
                ...
                <p>Already have an account? <span className="sign-up-text" onClick={() => dispatch(verticalModalContent('login'))} >Login</span></p>
                </>
            )}
        </Formik>
    )
