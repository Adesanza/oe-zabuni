...
const VerticalCenterModal = ({ children }) => {
  ...
  return (
    <Modal
      ...
      // centered
      contentClassName={`vertical-modal ${modalState.type === 'edit-user-profile' ? '' : 'vertical-modal-others'}`} 
      animation={false}
    ...
    >
      <Modal.Header>
        ...
        /> */}
        <img src="https://res.cloudinary.com/adesanza/image/upload/v1617978093/zabuni/Group_134_upqus9.svg" alt="cancel" className="modal-close-btn"  onClick={handleCloseModal} />
      </Modal.Header>
