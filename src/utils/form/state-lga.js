const getStateLga = (state) => lgaData[state];
...
const lgaData = {
    ...
    cities:['Arochukwu',
        ...
        'Obinkita',
        'Amoba'
    ]}, 'Bende', 'Ikwuano', 'Isiala Ngwa North', 'Isiala Ngwa South', 'Isuikwuato', 'Obi Ngwa', 'Ohafia', 'Osisioma', 'Ugwunagbo', 'Ukwa East', 'Ukwa West', 'Umuahia North', 'Umuahia South', 'Umu Nneochi'],
